...
export class MainNavigation extends AbstractComponent {
  ...
  getTemplate() {
    return `<nav class="main-navigation">
          <a href="#all" class="main-navigation__item main-navigation__item--all-movies main-navigation__item--active" id="main-navigation-all-movies">All movies</a>
          ...
          <a href="#stats" class="main-navigation__item main-navigation__item--additional" id="main-navigation-all-stats">Stats</a>
        </nav>
`;
  }
}
